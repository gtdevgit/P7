...
import com.example.go4lunch.data.googleplace.model.placedetails.AddressComponent;
import com.example.go4lunch.data.googleplace.model.placedetails.PlaceDetails;
import com.example.go4lunch.data.googleplace.model.placedetails.Result;
...
public class DetailRestaurantViewModelTest extends TestCase {
    ...
    public void testGetDetailRestaurantViewStateLiveData() throws InterruptedException {
        ...
        placeDetails.setResult(new Result(null,
                ...
                phone,
                new Geometry(
                        new com.example.go4lunch.data.googleplace.model.Location(latitude, longitue), null ),
                "",
                phone,
                name,
