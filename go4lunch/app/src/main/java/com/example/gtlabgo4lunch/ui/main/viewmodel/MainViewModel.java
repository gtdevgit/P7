...
import com.example.gtlabgo4lunch.data.googleplace.model.autocomplete.Prediction;
...
import com.example.gtlabgo4lunch.data.googleplace.model.placesearch.Result;
...
public class MainViewModel extends ViewModel {
    ...
    private boolean isActiveSearch(String searchText){
    ...
    private void combine(@Nullable Location location,
        ...
        // no search result if empty text
    ...
    public void setSearchText(String searchText) {
        ...
        if (searchText != null) {
            ...
            searchTextMutableLiveData.setValue(text);
            if (text.length() >= 3){
                loadAutocomplet(text);
            }
        }
    }

    private void loadAutocomplet(String query){
